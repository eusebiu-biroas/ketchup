...
| `max`             | `max`               |             | `number`                                     | `0`                    |
| `mode`            | `mode`              |             | `PaginatorMode.FULL \| PaginatorMode.SIMPLE` | `PaginatorMode.SIMPLE` |
...
| Name                                                 | Description          |
| ---------------------------------------------------- | -------------------- |
| `--paginator_font-size, --kup-paginator_font-size`   | Set size of the font |
| `--paginator_text-color, --kup-paginator_text-color` | Set color of text    |
